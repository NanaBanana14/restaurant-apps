...
/* harmony export */ });
/* harmony import */ var _data_restourantdb_source__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(562);
...
var RestaurantList = {
  ...
  afterRender: function afterRender() {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var restaurantListContainer, loadingIndicator, restaurants;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 3;
            _context2.next = 6;
            return _data_restourantdb_source__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.listRestaurants();
          case 6:
            ...
            if (restaurants.length === 0) {
              ...
              restaurants.forEach(function (restaurant) {
                var restaurantItem = (0,_templates_template_creator__WEBPACK_IMPORTED_MODULE_1__/* .createRestaurantItemTemplate */ .yK)(restaurant);
...
var Review = {
  render: function render() {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var restaurants, restaurantOptions, errorMessage;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
  ...
  afterRender: function afterRender() {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var reviewForm, errorMessage, successMessage;
          ...
          case 0:
            ...
            reviewForm.addEventListener('submit', /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
                var restaurantIdInput, nameInput, reviewInput, restaurantId, reviewData, response, successMsg, errorMsg, _errorMsg;
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      restaurantIdInput = document.getElementById('restaurant-id');
                      nameInput = document.getElementById('name');
                      reviewInput = document.getElementById('review');
                      restaurantId = restaurantIdInput.value;
                      reviewData = {
                        id: restaurantId,
                      ...
                      _context2.prev = 8;
                      _context2.next = 11;
                      return _data_restourantdb_source__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.addReview(reviewData);
                    case 11:
                      ...
                      if (!response.error) {
                        ...
                        errorMsg = 'Gagal menambahkan review. Silakan coba lagi.';
                    ...
                    case 15:
                      ...
                      _errorMsg = 'Terjadi kesalahan dalam mengirim review. Silakan coba lagi nanti.';
                      errorMessage.textContent = _errorMsg;
                      errorMessage.style.display = 'block';
                    case 20:
                    case "end":
                      return _context2.stop();
...
var Search = {
  ...
  afterRender: function afterRender() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var searchResultsContainer, loadingIndicator, searchButtonElement, searchInputElement, backButton;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            searchResultsContainer = document.getElementById('search-results');
            loadingIndicator = document.getElementById('loading-indicator');
            searchButtonElement = document.getElementById('searchButtonElement');
            searchInputElement = document.getElementById('searchElement');
            if (searchButtonElement) {
              searchButtonElement.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
                var query;
                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                  while (1) switch (_context3.prev = _context3.next) {
                    case 0:
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            case 0:
                              _context2.prev = 0;
                              _context2.next = 3;
                              return _data_restourantdb_source__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.searchRestaurants(query);
                            case 3:
                              results = _context2.sent;
                              _this.showSearchResults(searchResultsContainer, results);
                              _context2.next = 10;
                              break;
                            case 7:
                              _context2.prev = 7;
  ...
  showSearchResults: function showSearchResults(container, results) {
    var containerCopy = container;
    if (results.length === 0) {
      containerCopy.innerHTML = '<p class="pesan">No restaurants found for the given query.</p>';
    } else {
      var searchResultsHTML = results.map(function (restaurant) {
        return (0,_templates_template_creator__WEBPACK_IMPORTED_MODULE_1__/* .createRestaurantItemTemplate */ .yK)(restaurant);
      }).join('');
...
/* harmony export */   bh: () => (/* binding */ createRestaurantFavoriteItemTemplate),
...
var createRestaurantDetailTemplate = function createRestaurantDetailTemplate(restaurant) {
  return "\n <h2 class=\"restaurant-name\">".concat(restaurant.name, "</h2>\n <div class=\"restaurant-detail\">\n    <div class=\"restaurant-img-desc\">\n      <img class=\"restaurant-image\" src=\"").concat(_globals_api_endpoint__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.MEDIUM_IMAGE(restaurant.pictureId), "\" alt=\"").concat(restaurant.name, "\">\n      <h4>Description : </h4>\n      <p>").concat(restaurant.description, "</p>\n    </div>\n    <div class=\"restaurant-info\">\n      <h3>Information</h3>\n      <h4>City : ").concat(restaurant.city, "</h4>\n      <h4>Address : ").concat(restaurant.address, "</h4>\n      <h4>Rating : ").concat(restaurant.rating, "</h4>\n      <div class=\"restaurant-categories\">\n        <h4>Categories</h4>\n        <ul>\n            ").concat(restaurant.categories.map(function (category) {
  ...
  }).join(''), "\n            </ul>\n        </div>\n      </div>\n    </div>\n    <div class=\"restaurant-reviews\">\n      <div class=\"review-header-item\">\n        <h3>Customer Reviews</h3>\n        <button class=\"add-review headline__button\" id=\"add-review-button\" data-id=\"").concat(restaurant.id, "\">Add Review</button>\n      </div>\n      <ul>\n        ").concat(restaurant.customerReviews.map(function (review) {
    return "\n          <li>\n            <h4>".concat(review.name, "</h4>\n            <p>").concat(review.review, "</p>\n            <p>").concat(review.date, "</p>\n          </li>\n        ");
  }).join(''), "\n      </ul>\n    </div>\n  </div>\n");
};
var createRestaurantItemTemplate = function createRestaurantItemTemplate(restaurant) {
  return "\n        <div class=\"restaurant-card\">\n            <img class=\"lazyload resto-img\" src=\"".concat(_globals_api_endpoint__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.MEDIUM_IMAGE(restaurant.pictureId), "\" class=\"restaurant-image\" alt=\"").concat(restaurant.name, "\">\n            <div class=\"restaurant-details\">\n                <p class=\"city-restaurant\">Kota: ").concat(restaurant.city, "</p>\n                <p class=\"rating\">Rating: ").concat(restaurant.rating, "</p>\n            </div>\n            <div class=\"restaurant-info\">\n                <h3><a href=\"#/detail/").concat(restaurant.id, "\" class=\"restaurant-detail-name\">").concat(restaurant.name, "</a></h3>\n                <p>").concat(restaurant.description, "</p>\n            </div>\n        </div>\n");
};
var createRestaurantFavoriteItemTemplate = function createRestaurantFavoriteItemTemplate(restaurant) {
  return "\n        <div class=\"restaurant-card\">\n            <img class=\"lazyload resto-img\" src=\"".concat(_globals_api_endpoint__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.MEDIUM_IMAGE(restaurant.pictureId), "\" class=\"restaurant-image\" alt=\"").concat(restaurant.name, "\">\n            <div class=\"restaurant-details\">\n                <p class=\"city-restaurant\">Kota: ").concat(restaurant.city, "</p>\n                <p class=\"rating\">Rating: ").concat(restaurant.rating, "</p>\n            </div>\n            <div class=\"restaurant-info\">\n                <h3><a href=\"#/detail/").concat(restaurant.id, "\" class=\"restaurant-detail-name\">").concat(restaurant.name, "</a></h3>\n            </div>\n        </div>\n");
};
